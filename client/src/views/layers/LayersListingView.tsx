...
export default function LayersListingView({ type, service, specification }: LayersListingViewProps) {
    ...
    const confirmDuplicate = async () => {
        try {
            ...
            console.error(`[${Date.now()}] Error duplicating layer: ${error}`);
        }
    }
    ...
    const onSubmit = async (linkResource: LinkResourceDto, mapInstanceIds: string[]) => {
        try {
            ...
            console.error(`[${Date.now()}] Error updating source: ${error}`);
        }
    }
    ...
    const confirmDelete = async () => {
        try {
            ...
            console.error(`[${Date.now()}] Error deleting ${type} Layer: ${error}`);
        }
    };
