import { MapInstanceDto, MapInstanceListItemDto, PublishedMapBaseDto, PublishedMapConfigDto, PublishedMapDto, SyncLayerRequestDto } from "@/shared/interfaces/dtos";
